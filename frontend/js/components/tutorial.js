const TUTORIAL_STEPS = [
    {
        ...
        desc: `Это экономическая стратегия, где ты управляешь своей пивоварней. Твоя цель — заработать ${formatMoney(100000)} выручки.`,
    ...
    },
    {
        ...
        tip: `Бери кредиты осторожно — ставка до 1%/день. Долг более ${formatMoney(5000)} на 30 дней = банкротство!`,
    },
];
