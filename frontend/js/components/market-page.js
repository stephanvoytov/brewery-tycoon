...
function renderMarketContracts() {
    ...
    el.innerHTML = `
        <div class="grid-2">
            <div class="card">
                <h3>📋 Контракты <span class="help-link" onclick="scrollToHelp('help-guide-contracts'); return false;" title="Подробнее о контрактах">❓</span></h3>
                <table>
                    <tr>
                        <th>Покупатель</th>
                        <th>Сорт</th>
...
function renderMarketCompetitors() {
    ...
    el.innerHTML = `
        <div class="card">
            <h3>🏢 Конкуренты <span class="help-link" onclick="scrollToHelp('help-guide-competitors'); return false;" title="Подробнее о конкурентах">❓</span></h3>
            <table>
...
function renderMarketMarketing() {
    ...
    el.innerHTML = `
        <div class="card">
            <h3>📣 Маркетинг <span class="help-link" onclick="scrollToHelp('help-guide-marketing'); return false;" title="Подробнее о маркетинге">❓</span></h3>
