    ...
    return `
        ...
        <div class="help-section" id="help-guide-tax">
            ...
            <ul>
                ...
                <li>Минимум <strong>$200</strong></li>
            </ul>
        ...
        <div class="help-section" id="help-guide-taproom">
            ...
            <div class="grid-2">
                <div class="help-card">
                    <h3>🔨 Как открыть</h3>
                    <p>Тапрум строится в разделе <strong>🏭 Пивоварня → Улучшения</strong>. Стоимость: <strong>$5,000</strong> (1 ур.) и <strong>$10,000</strong> (2 ур.). Здание «Крафт-лофт» имеет тапрум по умолчанию.</p>
                    <ul>
                        <li><strong>Доход:</strong> $30/день за каждый уровень</li>
                ...
                <div class="help-card">
                    ...
                    <ul>
                        <li>1 ур. = $30/день ($900/мес)</li>
                        <li>2 ур. = $60/день ($1,800/мес)</li>
                        <li>С исследованием: 1 ур. = $39/день</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="grid-2">
                <div class="help-card">
                    ...
                    <table>
                        ...
                        <tr><td>🕳 Подвал</td><td>1</td><td>$40</td><td>1×50л</td><td>2</td><td>−5%</td></tr>
                        <tr><td>🏗 Цех</td><td>1</td><td>$100</td><td>2×100л</td><td>4</td><td>0%</td></tr>
                        <tr><td>🏭 Промздание</td><td>4</td><td>$200</td><td>3×100л</td><td>6</td><td>−5%</td></tr>
                        <tr><td>🎨 Крафт-лофт</td><td>7</td><td>$300</td><td>2×100л</td><td>4</td><td>+10%</td></tr>
                        <tr><td>🏭 Завод</td><td>12</td><td>$500</td><td>4×200л</td><td>8</td><td>−10%</td></tr>
                        <tr><td>🔬 Лаборатория</td><td>15</td><td>$800</td><td>2×100л</td><td>6</td><td>+20%</td></tr>
                        <tr><td>🌐 Холдинг</td><td>18</td><td>$1,200</td><td>6×200л</td><td>12</td><td>−5%</td></tr>
                    </table>
                </div>
                <div class="help-card">
                    <h3>🔀 Переезд</h3>
                    ...
                    <ul>
                        <li>Аренда × 15</li>
                        <li>+ $500 за каждый танк</li>
                        <li>+ $300 за каждый ферментер</li>
                        <li>+ $300 за каждый лагерный танк</li>
                        <li>+ $2,000 если есть тапрум</li>
                        <li>+ $200 за каждое оборудование</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="help-section" id="help-guide-staff">
            ...
            <div class="grid-2">
                <div class="help-card">
                    <h3>🍺 Пивовар</h3>
                    <p><strong>Зарплата:</strong> $25/день. <strong>Бонус:</strong> +2% к скорости варки за единицу навыка.</p>
                    <p>Чем выше навык, тем быстрее партии проходят все стадии. Ключевой сотрудник для производства.</p>
                </div>
                <div class="help-card">
                    <h3>🤝 Продавец</h3>
                    <p><strong>Зарплата:</strong> $20/день. <strong>Бонус:</strong> +2% к цене контрактов за единицу навыка.</p>
                    <p>Увеличивает выручку по всем активным контрактам. Окупается при больших объёмах продаж.</p>
                </div>
                <div class="help-card">
                    <h3>📋 Администратор</h3>
                    <p><strong>Зарплата:</strong> $15/день. <strong>Бонус:</strong> −2% к расходам (аренда) за единицу навыка.</p>
                ...
                <div class="help-card">
                    ...
                    <ul>
                        ...
                        <li><strong>Навык:</strong> 1–10. Тренировка стоит навык × $200</li>
        ...
        <div class="help-section" id="help-guide-research">
            ...
            <div class="grid-2">
                <div class="help-card">
                    ...
                    <ul>
                        <li><strong>Автоматизация варки</strong> — $5,000, 5 дн. Скорость варки +20%</li>
                        <li><strong>Крафтовая линия</strong> — $8,000, 7 дн. Качество +10%</li>
                        <li><strong>Контроль качества</strong> — $6,000, 6 дн. Порча −50%</li>
                    </ul>
                </div>
                <div class="help-card">
                    <h3>📜 Рецепты</h3>
                    <ul>
                        <li><strong>Солодовня</strong> — $3,000, 3 дн. Открывает новые рецепты</li>
                    </ul>
                    <h3 style="margin-top:12px">📢 Маркетинг</h3>
                    <ul>
                        <li><strong>Маркетинг в соцсетях</strong> — $2,000, 2 дн. Репутация +5, спрос +10%</li>
                        <li><strong>Экскурсии на пивоварню</strong> — $4,000, 4 дн. Доход тапрума ×1.3</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="grid-2">
                <div class="help-card">
                    <table>
                        ...
                        <tr><td>🍾 Линия розлива</td><td>$4,000</td><td>Цена продажи +15%</td></tr>
                        <tr><td>🧊 Охлаждение</td><td>$3,000</td><td>Ферментация −1 день</td></tr>
                        <tr><td>🛢 Лагерный танк</td><td>$2,500</td><td>Дозревание −2 дня</td></tr>
                        <tr><td>🛞 Линия кегов</td><td>$5,000</td><td>Объём партии +10%</td></tr>
                        <tr><td>🏺 Заторный чан</td><td>$1,800</td><td>Качество +5%</td></tr>
                        <tr><td>🔬 Фильтрация</td><td>$3,500</td><td>Варка −1 день</td></tr>
                    </table>
                </div>
                <div class="help-card">
                    ...
                    <ul>
                        ...
                        <li><strong>Страховка:</strong> $500, чинит первую поломку бесплатно</li>
            ...
            <div class="grid-2">
                <div class="help-card">
                    ...
                    <table>
                        ...
                        <tr><td>💰 Первая выручка</td><td>Выручка ≥ $10,000</td><td>Репутация +5</td></tr>
                        <tr><td>💵 Серьёзный пивовар</td><td>Выручка ≥ $50,000</td><td>Репутация +10</td></tr>
                        <tr><td>🏆 Пивной магнат</td><td>Выручка ≥ $100,000</td><td>Репутация +15</td></tr>
        ...
        <div class="help-section" id="help-guide-loans">
            ...
            <div class="grid-2">
                <div class="help-card">
                    ...
                    <ul>
                        <li><strong>Лимит:</strong> $5,000 + репутация × $200 + уровень × $1,000</li>
                ...
                <div class="help-card">
                    <h3>💀 Банкротство</h3>
                    <p>Если долг превышает <strong>$5,000</strong> и держится больше <strong>30 дней</strong> подряд — игра заканчивается.</p>
                    <ul>
