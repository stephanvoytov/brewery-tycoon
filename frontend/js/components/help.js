    ...
    el.innerHTML = `
        ...
        <div class="help-section">
            ...
            <div class="grid-2">
                ...
                <div class="help-card">
                    <h3>⭐ Репутация</h3>
                    <p>Влияет на цену продажи и доступные контракты. Формула изменения:</p>
                    <ul>
                        ...
                        <li><strong>Достижения:</strong> +5-15 за открытие</li>
                    </ul>
                    <p style="margin-top:6px">Репутация больше не меняется случайно — только от ваших действий.</p>
                </div>
                <div class="help-card">
                ...
                <div class="help-card">
                    <h3>📋 Контракты</h3>
                    <p>Бары, магазины и рестораны предлагают контракты на поставку пива. Штраф за срыв — неустойка 20% от суммы. Выгодно выполнять крупные заказы.</p>
                </div>
                <div class="help-card">
                    <h3>🏦 Кредит и банкротство</h3>
                    <p>При отрицательном балансе выдаётся кредит под <strong>1% в день</strong>. Если долг превысит <strong>$5,000</strong> и будет держаться больше <strong>30 дней</strong> — игра заканчивается банкротством. Следите за балансом!</p>
                </div>
                <div class="help-card">
                    <h3>🌾 Порча ингредиентов</h3>
                    <p>Каждый день <strong>0.5%</strong> всех ингредиентов списывается. Не закупайте слишком много — продукты портятся. Покупайте ровно столько, сколько нужно на ближайшие варки.</p>
                </div>
                <div class="help-card">
                    <h3>🏆 Цель игры</h3>
                    <p>Заработайте <strong>$100,000</strong> общей выручки. Следите за прогрессом на дашборде. Достигайте промежуточных целей для бонусов.</p>
                </div>
                <div class="help-card">
                    <h3>⚙️ Износ и ремонт</h3>
                    <p>Всё оборудование изнашивается на <strong>−0.1%/день</strong>. При износе <strong>ниже 20%</strong> оборудование ломается и перестаёт давать бонус к эффективности.</p>
                    <ul>
                        <li><strong>Ремонт:</strong> 30% от цены оборудования, кнопка в 🏭 Пивоварня</li>
                        <li><strong>Страховка ($500):</strong> автоматически чинит первую поломку</li>
                    </ul>
                    <p style="margin-top:6px">Следите за износом в разделе «Оборудование».</p>
                </div>
                <div class="help-card">
                    <h3>🏭 Конкуренты</h3>
                    <p>В вашем регионе работают 3–5 AI-пивоварен. Каждый день они продают 50–300 литров (зависит от репутации). Ваша <strong>доля рынка</strong> отображается на дашборде и показывает, какую часть рынка вы контролируете.</p>
                </div>
                <div class="help-card">
                    <h3>⚡ Случайные события</h3>
                    <p>Каждый день с <strong>10% шансом</strong> происходит одно из 8 событий:</p>
                    <ul>
                        <li>🔧 <strong>Поломка котла</strong> — выбор: ремонт $500 / простой 3 дня</li>
                        ...
                        <li>🏪 <strong>Предложение от сети</strong> — $2000 или репутация +5</li>
                        <li>📰 <strong>Статья в газете</strong> — $500 за +10 репутации</li>
                        <li>🐛 <strong>Вредители</strong> — дезинсекция $300 или −5 кг</li>
                    </ul>
                    <p style="margin-top:6px">События с выбором открывают модальное окно — внимательно читайте последствия!</p>
                </div>
            </div>
        </div>
