...
function renderGuideTab() {
    return `
        ...
        <div class="help-section" id="help-guide-buildings">
            ...
            <div class="grid-2">
                <div class="help-card">
                    <h3>📋 Все здания</h3>
                    <table>
                        <tr><th>Здание</th><th>Ур.</th><th>Аренда</th><th>Котлы</th><th>Ферм.</th><th>Кач-во</th></tr>
                    ...
                    <p style="font-size:0.8rem;margin-top:6px;color:var(--text-dim)">Котлы и ферментеры покупаются и продаются поштучно в разделе <strong>🏭 Пивоварня → Магазин</strong>. Каждое здание имеет лимит слотов и макс. объём на единицу (например, Комната: 1 котёл до 50л, 2 ферментера до 50л). В Комнате нельзя установить бонусное оборудование — переезжайте в Подвал или Цех.</p>
                </div>
                <div class="help-card">
                    <h3>🔀 Переезд</h3>
        ...
        <div class="help-section" id="help-guide-equipment">
            ...
            <div class="grid-2">
                <div class="help-card">
                    <h3>🍺 Котлы, ферментеры и танки</h3>
                    <p>В разделе <strong>🏭 Пивоварня → Оборудование</strong> можно купить отдельные котлы, ферментеры и лагерные танки разных объёмов — от 50л до 1000л. Цена зависит от размера:</p>
                    <ul>
                        <li><strong>Котлы:</strong> 50л (2000) → 100л (4000) → 200л (8000) → 500л (15000) → 1000л (30000)</li>
                        <li><strong>Ферментеры:</strong> 50л (1000) → 100л (2000) → 200л (4000) → 500л (10000) → 1000л (20000)</li>
                        <li><strong>Лагерные танки:</strong> 50л (1500) → 100л (3000) → 200л (6000) → 500л (14000) → 1000л (28000)</li>
                    </ul>
                    <p>Продажа оборудования возвращает <strong>60%</strong> от цены покупки. Каждое здание имеет лимит слотов и макс. объём на единицу — нельзя поставить 1000л котёл в Комнату.</p>
                </div>
                <div class="help-card">
                    <h3>⚡ Бонусное оборудование</h3>
                    <p>Помимо котлов, есть 6 видов уникального оборудования с постоянными бонусами:</p>
                    <table>
